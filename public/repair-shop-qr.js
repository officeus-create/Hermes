(() => {
  ...
  style.textContent = `.repair-qr-panel,.repair-qr-copy,.repair-qr-media,.repair-qr-actions{min-width:0;max-width:100%}.repair-qr-panel{display:flex;justify-content:space-between;gap:22px;align-items:center;width:100%;margin-top:10px;padding:18px;overflow:hidden;border:1px solid rgba(124,92,255,.16);border-radius:16px;background:rgba(124,92,255,.05)}.repair-qr-panel.hidden{display:none!important}.repair-qr-copy{max-width:540px}.repair-qr-copy strong,.repair-qr-copy p{overflow-wrap:anywhere;word-break:normal}.repair-qr-copy strong{font-size:16px}.repair-qr-copy p{margin:7px 0 0;color:#9ea5b4;font-size:12px;line-height:1.55}.repair-qr-media{display:flex;flex:0 1 auto;align-items:center;gap:12px}.repair-qr-media img{display:block;width:140px;height:140px;max-width:100%;padding:7px;border-radius:10px;background:#fff}.repair-qr-actions{display:grid;gap:8px}.repair-qr-actions button{min-width:0;max-width:100%;min-height:44px;white-space:normal;overflow-wrap:anywhere}@media(max-width:720px){.repair-qr-panel,.repair-qr-media{display:block}.repair-qr-panel{padding:14px}.repair-qr-media{width:100%;margin-top:14px}.repair-qr-media img{width:min(240px,100%);height:auto;margin:0 auto}.repair-qr-actions{grid-template-columns:minmax(0,1fr) minmax(0,1fr);width:100%;margin-top:12px}}@media(max-width:420px){.repair-qr-actions{grid-template-columns:1fr}}`;
