(() => {
  ...
  const copy = {
    ...
    es: {
      ...
      placeholder:"Buscar por nombre, email, teléfono, vehículo, VIN o servicio", customer:"cliente", customers:"clientes", booking:"reserva", bookings:"reservas", completed:"completadas", next:"Próxima", at:"a las", lastSeen:"Última visita", alerts:{}
    },
    it: {
      ...
      placeholder:"Cerca per nome, email, telefono, veicolo, VIN o servizio", customer:"cliente", customers:"clienti", booking:"prenotazione", bookings:"prenotazioni", completed:"completate", next:"Prossimo", at:"alle", lastSeen:"Ultima visita", alerts:{}
    },
    fr: {
      ...
      placeholder:"Rechercher par nom, email, téléphone, véhicule, VIN ou service", customer:"client", customers:"clients", booking:"réservation", bookings:"réservations", completed:"terminées", next:"Prochain", at:"à", lastSeen:"Dernière visite", alerts:{}
    }
  }[locale];
  if (!copy) return;
