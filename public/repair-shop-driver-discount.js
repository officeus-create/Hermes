(() => {
  ...
  function addStyles() {
    ...
    style.textContent = `
      .hc-driver-discount-owner{scroll-margin-top:132px;margin-top:24px;border-color:rgba(34,197,94,.28)!important;background:linear-gradient(135deg,rgba(34,197,94,.075),rgba(255,255,255,.018))!important}
