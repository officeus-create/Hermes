...
assert.match(consent, /PRODUCTION_ANALYTICS_HOSTS/); assert.match(consent, /analyticsDeliveryAllowed/); assert.match(consent, /disabled-non-production/); assert.match(consent, /if \(!analyticsDeliveryAllowed\(\)\)/);
