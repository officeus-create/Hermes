...
console.log("Analytics/vendor consent contract passed: main + Connect GA4 are consent-gated, shared events use one direct gtag transport, and advertising vendors remain blocked.");