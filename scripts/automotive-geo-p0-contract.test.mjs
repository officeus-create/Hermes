...
assert.match(repairPage, /title="Auto Repair Scheduling Software \| Hermes Connect"/);
assert.match(repairPage, /Auto repair scheduling software for independent repair shops\./);
