...
assert.match(repairPage, /title="Auto Repair CRM & Scheduling Software \| Hermes Connect"/);
assert.match(repairPage, /Auto repair CRM, online booking & scheduling for independent shops\./);
