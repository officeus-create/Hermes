...
const replacements = [
  ...
  ["<dt>Posted</dt><dd>18 min ago</dd>", "<dt>Demo status</dt><dd>Fictional sample A</dd>"],
  ["<dt>Pickup</dt><dd>Jul 23</dd>", "<dt>Pickup</dt><dd>Demo day +2</dd>"],
  ["<dt>Posted</dt><dd>41 min ago</dd>", "<dt>Demo status</dt><dd>Fictional sample B</dd>"],
  ["<dt>Pickup</dt><dd>Jul 24 · appointment</dd>", "<dt>Pickup</dt><dd>Demo day +3 · appointment</dd>"],
  ["<dt>Posted</dt><dd>1 hr ago</dd>", "<dt>Demo status</dt><dd>Fictional sample C</dd>"],
  ["<dt>Pickup</dt><dd>Jul 25–26</dd>", "<dt>Pickup</dt><dd>Demo day +4–5</dd>"],
  ["<dt>Posted</dt><dd>2 hr ago</dd>", "<dt>Demo status</dt><dd>Fictional sample D</dd>"],
];
