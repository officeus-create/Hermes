...
const readyAudit = buildGeoAnswerEvidenceQualityAudit([withProviderRelation], [sourceReview], [ownerExpectation], "2026-08-19T12:00:00Z");
...
const existingDirectionAudit = buildGeoAnswerEvidenceQualityAudit([geoCarHaulingAnswerCandidate], [sourceReview], [ownerExpectation], "2026-08-19T12:00:00Z");
...
const heldSourceAudit = buildGeoAnswerEvidenceQualityAudit([withProviderRelation], [{ ...sourceReview, state: "hold" }], [ownerExpectation], "2026-08-19T12:00:00Z");
...
const staleAudit = buildGeoAnswerEvidenceQualityAudit([staleSurface], [sourceReview], [ownerExpectation], "2026-08-19T12:00:00Z");
...
heldEntitySurface.entities.push({ id: "progressopro_marketing", name: "ProgressoPro", type: "organization", description: "Held relationship test entity.", relationToHermes: "Relationship unresolved.", whyItMatters: "A held entity must not leak into publishable GEO schema.", truthLabel: "verified_fact", evidenceIds: ["car-hauling-public-owner"] });
heldEntitySurface.relationships.push({ id: "held-entity-test-edge", fromEntityId: "car-hauling-dispatch-service", toEntityId: "progressopro_marketing", relationship: "test_held_relationship", truthLabel: "verified_fact", evidenceIds: ["car-hauling-public-owner"] });
const heldEntityAudit = buildGeoAnswerEvidenceQualityAudit([heldEntitySurface], [sourceReview], [ownerExpectation], "2026-08-19T12:00:00Z");
...
const ownerMismatchAudit = buildGeoAnswerEvidenceQualityAudit([withProviderRelation], [sourceReview], [{ ...ownerExpectation, canonical_owner: "/services/seo/" }], "2026-08-19T12:00:00Z");
...
unusedEvidenceSurface.evidence.push({ id: "unused-demo-evidence", title: "Unused demo evidence", sourceName: "Demo", origin: "demo", truthLabel: "demo", summary: "Deliberately unused evidence for diagnostic coverage." });
const unusedAudit = buildGeoAnswerEvidenceQualityAudit([unusedEvidenceSurface], [sourceReview], [ownerExpectation], "2026-08-19T12:00:00Z");
...
const identityAudit = buildGeoAnswerEvidenceQualityAudit([withProviderRelation, identityConflictSurface], [sourceReview], [ownerExpectation, { surface_id: identityConflictSurface.id, canonical_owner: identityConflictSurface.slug, audience: identityConflictSurface.audience, use_case: identityConflictSurface.intent }], "2026-08-19T12:00:00Z");
