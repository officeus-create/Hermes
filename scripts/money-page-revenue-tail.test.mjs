...
const pages = [
  ["dist/logistics/car-hauling-dispatch/index.html", "Start dispatch review", "/logistics/start-car-hauling-dispatch/", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/appleton-wi-vehicle-transport/index.html", "Prepare Appleton request", "/logistics/request-vehicle-transport/#transport-intake", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/wisconsin-vehicle-transport/index.html", "Prepare transport request", "/logistics/request-vehicle-transport/#transport-intake", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/green-bay-wi-vehicle-transport/index.html", "Prepare transport request", "/logistics/request-vehicle-transport/#transport-intake", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/dealer-vehicle-transportation/index.html", "Prepare dealer request", "request=dealer_inventory", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/auction-vehicle-pickup/index.html", "Prepare auction request", "request=auction_pickup", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/wisconsin-dealer-vehicle-transport/index.html", "Prepare dealer request", "request=dealer_inventory", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/wisconsin-auction-vehicle-pickup/index.html", "Prepare auction request", "request=auction_pickup", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/wisconsin-enclosed-vehicle-transport/index.html", "Prepare enclosed request", "/logistics/request-vehicle-transport/#transport-intake", "mailto:officeus@hermeslogisticsus.com"],
  ["dist/logistics/wisconsin-multi-vehicle-dealer-transport/index.html", "Prepare multi-vehicle request", "request=dealer_inventory", "mailto:officeus@hermeslogisticsus.com"],
