...
const pages = [
  {
    ...
    title: "Car Hauler Dispatch Service for Owner-Operators | Hermes",
    h1: "Car Hauler Dispatch Service for Owner-Operators and Small Fleets",
    required: [
      ...
      "What happens after I complete the carrier intake?",
      "Submission does not automatically create an account, assign a dispatcher, book a load, or guarantee acceptance.",
  ...
  },
  {
    ...
    required: [
      ...
      "What should we do if pickup or delivery timing changes?",
