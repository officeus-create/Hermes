...
assert.ok(
  ...
  "Car Hauling Dispatch owner must retain the bounded Broker Setup Packet supporting-resource edge",
);
assert.ok(
  carHaulingOwner.includes('href="/logistics/resources/new-authority-car-hauler-readiness-checklist/"'),
  "Car Hauling Dispatch owner must retain the bounded New Authority readiness supporting-resource edge",
);
