...
assert.match(transportApi, /stableDealerLoadIds/);
assert.match(transportApi, /crypto\.subtle\.digest\("SHA-256"/);
assert.match(transportApi, /INSERT OR IGNORE INTO hermes_load_records/);
assert.match(transportApi, /INSERT OR IGNORE INTO hermes_load_market_posts/);
