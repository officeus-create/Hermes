...
panel_ai = '      <a class:list={["hc-account-workspace", "ai", current === "ai" && "is-current"]} href="/services/hermes-connect/internal/ai-connect/" data-workspace-ai data-hc-workspace-link="ai" hidden>\n'
panel_hr = '''      <a class:list={["hc-account-workspace", "hr", current === "hr" && "is-current"]} href="/demos/hermes-connect/hr-admin.html" data-workspace-hr data-hc-workspace-link="hr" hidden>\n        <span class="hc-workspace-dot" aria-hidden="true"></span>\n        <span><strong data-hc-copy="hr">{t.hr}</strong><small data-hc-copy="internal">{t.internal}</small></span>\n        <em data-hc-copy={current === "hr" ? "current" : "open"}>{current === "hr" ? t.current : t.open}</em>\n      </a>\n'''
assert text.count(panel_ai) == 1, 'unexpected panel AI anchor baseline'
text = text.replace(panel_ai, panel_hr + panel_ai, 1)

menu_ai = '        <a class:list={["hc-account-workspace", "ai", current === "ai" && "is-current"]} href="/services/hermes-connect/internal/ai-connect/" data-workspace-ai data-hc-workspace-link="ai" hidden>\n'
menu_hr = '''        <a class:list={["hc-account-workspace", "hr", current === "hr" && "is-current"]} href="/demos/hermes-connect/hr-admin.html" data-workspace-hr data-hc-workspace-link="hr" hidden>\n          <span class="hc-workspace-dot" aria-hidden="true"></span>\n          <span><strong data-hc-copy="hr">{t.hr}</strong><small data-hc-copy="internal">{t.internal}</small></span>\n          <em data-hc-copy={current === "hr" ? "current" : "open"}>{current === "hr" ? t.current : t.open}</em>\n        </a>\n'''
assert text.count(menu_ai) == 1, 'unexpected menu AI anchor baseline'
text = text.replace(menu_ai, menu_hr + menu_ai, 1)
