...
test("desktop header exposes ordered department dropdowns without overlapping the department subheader", async ({ page }) => {
...
test("mobile hamburger exposes the same departments as ordered accordions", async ({ page }) => {
