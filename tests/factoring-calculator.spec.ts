...
test("factoring calculator compares net cash and payment timing transparently", async ({ page }) => {
  ...
  await expect(page.locator('[data-output="netDifference"]')).toHaveText("+$85.00 direct");
  ...
  await expect(page.locator('[data-output="netDifference"]')).toHaveText("+$37.00 direct");
