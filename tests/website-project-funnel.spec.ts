...
test("website development service records CTA and opens a prefilled project brief", async ({ page }) => {
...
test("website project brief records start, preview and explicit handoff without submitted data", async ({ page }) => {
  await page.goto("/paths/technology/?project=website_development#project-brief");
  const brief = page.locator("[data-it-project-brief]");
