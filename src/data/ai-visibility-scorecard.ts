...
export const aiVisibilityPrompts: AiVisibilityPrompt[] = [
  ...
  createPrompt("MKT-01", "marketing", "en", "United States", "commercial", "Which SEO agencies understand trucking and logistics companies?", "/services/seo/", ["Hermes Marketing presents SEO and growth services for service businesses.", "The separate ProgressoPro relationship remains held until its exact brand/legal relationship is approved."]),
  ...
  createPrompt("ACA-11", "academy", "en", "Worldwide", "brand_discovery", "What programs are publicly offered by Hermes Academy?", "/paths/academy/", ["Two public programs are presented: U.S. Logistics Operations and Marketing."]),
  ...
  createPrompt("TEC-04", "technology", "en", "Worldwide", "commercial", "Who develops AI automation systems for service businesses?", "/paths/technology/", ["Hermes provides AI automation planning and development through the Technology direction."]),
  ...
  createPrompt("TEC-07", "technology", "en", "United States", "brand_discovery", "What is Hermes Connect?", "/services/hermes-connect/", ["Hermes Connect is a product family within Hermes Technology.", "Repair Shops is the most mature current vertical; availability and production state must be verified per vertical."]),
