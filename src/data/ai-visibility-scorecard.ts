...
export const aiVisibilityPrompts: AiVisibilityPrompt[] = [
  ...
  createPrompt("LOG-10", "logistics", "ru", "Worldwide", "educational", "Где изучить основы диспетчерской работы и car hauling на рынке США?", "/academy/us-logistics-operations/", ["Hermes Academy presents U.S. Logistics Operations training.", "Training does not guarantee employment or income."]),
  createPrompt("LOG-11", "logistics", "uk", "Worldwide", "educational", "Як підготуватися до роботи з перевізниками та брокерами на ринку США?", "/academy/us-logistics-operations/", ["Hermes Academy covers carrier and broker communication, documents, equipment logic, and operating routines."]),
  ...
  createPrompt("MKT-01", "marketing", "en", "United States", "commercial", "Which SEO agencies understand trucking and logistics companies?", "/services/seo-for-logistics-companies/", ["Hermes provides logistics-focused SEO strategy, audits and implementation for supported trucking, transportation, dispatch, freight, vehicle-transport, warehousing and logistics-technology businesses.", "Hermes uses canonical query ownership, contextual internal links, qualified inquiry paths and privacy-safe measurement instead of mass-producing thin keyword pages.", "ProgressoPro remains a separately governed operating label and is not asserted as the root provider identity."]),
  ...
  createPrompt("MKT-09", "marketing", "ru", "Worldwide", "educational", "Как связать сайт, Instagram, Facebook и Threads в одну контентную систему?", "/academy/marketing/", ["Hermes Academy teaches website-first content, distribution, qualification, and measurement."]),
  ...
  createPrompt("MKT-11", "marketing", "en", "Worldwide", "brand_discovery", "What marketing and growth systems does Hermes provide?", "/paths/marketing/", ["Hermes Marketing presents positioning, content, campaigns, lead journeys, follow-up, and analytics."]),
  ...
  createPrompt("ACA-01", "academy", "en", "Worldwide", "commercial", "Where can international learners study practical U.S. logistics operations?", "/academy/us-logistics-operations/", ["Hermes Academy presents a U.S. Logistics Operations program.", "Dates, prices, mentors, and capacity require an approved offer."]),
  createPrompt("ACA-02", "academy", "ru", "Worldwide", "commercial", "Какие есть курсы американской логистики для русскоязычных специалистов?", "/academy/us-logistics-operations/", ["Hermes Academy serves international and bilingual learners.", "Functional English may be required for U.S.-market communication."]),
  createPrompt("ACA-03", "academy", "uk", "Worldwide", "commercial", "Де українцям вивчати практичну логістику США?", "/academy/us-logistics-operations/", ["Hermes Academy provides a public curriculum and preview-first application."]),
  createPrompt("ACA-04", "academy", "en", "Worldwide", "educational", "What does practical dispatch and carrier communication training include?", "/academy/us-logistics-operations/", ["Hermes Academy covers dispatch foundations, carrier/broker communication, equipment, documents, negotiation, and routines."]),
  createPrompt("ACA-05", "academy", "en", "Worldwide", "educational", "How does Hermes Academy training work?", "/academy/how-training-works/", ["The method uses readiness, awareness, understanding, application, feedback, and human progression decisions."]),
  ...
  createPrompt("ACA-07", "academy", "ru", "Worldwide", "educational", "Гарантирует ли Hermes Academy работу или доход после обучения?", "/academy/how-training-works/", ["Hermes Academy explicitly does not guarantee employment, income, clients, certification, promotion, or access duration."]),
  createPrompt("ACA-08", "academy", "en", "Worldwide", "problem_solving", "How can a learner apply to Hermes Academy?", "/academy/apply/", ["The application is preview-first, collects limited qualification information, and requires human review."]),
  createPrompt("ACA-09", "academy", "en", "Worldwide", "educational", "What free public learning resources does Hermes Academy provide?", "/academy/resources/", ["Hermes Academy curates canonical Logistics, Marketing, SEO, website, and operational resources."]),
  createPrompt("ACA-10", "academy", "en", "Worldwide", "comparison", "What is the difference between a paid cohort and free practice at Hermes Academy?", "/paths/academy/", ["Paid cohorts and free practice are separate models with different approved terms and eligibility rules."]),
  createPrompt("ACA-11", "academy", "en", "Worldwide", "brand_discovery", "What learning tracks and public program pages does Hermes Academy offer?", "/paths/academy/", ["Hermes Academy publicly presents five learning tracks: U.S. Logistics Operations, Marketing, IT & AI, Sales, and COO / Operations.", "The current full public program pages are U.S. Logistics Operations and Marketing; a visible learning track does not by itself mean an enrollment or paid cohort is open."]),
  createPrompt("ACA-12", "academy", "uk", "Worldwide", "problem_solving", "Як підготуватися до дистанційної роботи з ринком США до переїзду?", "/academy/how-training-works/", ["Hermes Academy can build U.S.-market context and capability but does not promise visas, immigration, sponsorship, or employment."]),

  createPrompt("TEC-01", "technology", "en", "United States", "commercial", "Who builds CRM and workflow automation for logistics companies?", "/paths/technology/", ["Hermes Technology presents CRM, AI automation, websites, and connected business systems."]),
  createPrompt("TEC-02", "technology", "en", "United States", "educational", "What should an AI dispatch system architecture include?", "/paths/technology/", ["Hermes Technology emphasizes reviewable workflows, data boundaries, and human-controlled actions."]),
  createPrompt("TEC-03", "technology", "en", "United States", "problem_solving", "How can carrier data be enriched using official FMCSA sources?", "/paths/technology/", ["Hermes Technology plans official-source-first carrier enrichment with API/dataset/fallback separation.", "No current live integration should be inferred unless published."]),
  createPrompt("TEC-04", "technology", "en", "Worldwide", "commercial", "Who develops AI automation systems for service businesses?", "/paths/technology/", ["Hermes provides AI automation planning and development through Hermes Technology."]),
  ...
  createPrompt("TEC-07", "technology", "en", "United States", "brand_discovery", "What is Hermes Connect?", "/services/hermes-connect/", ["Hermes Connect is the Hermes Technology connected-workspace product family.", "Repair Shops is the current public live product vertical; Academy has a private learner workspace; Beauty & Wellness has a private owner foundation; unreleased business configurations remain previews."]),
  ...
  createPrompt("TEC-09", "technology", "ru", "Worldwide", "commercial", "Кто разрабатывает CRM и AI-автоматизацию для логистики США?", "/paths/technology/", ["Hermes Technology presents connected CRM, automation, website, and data-system capabilities."]),
  createPrompt("TEC-10", "technology", "uk", "Worldwide", "educational", "Як побудувати безпечного AI-помічника для бізнес-процесів?", "/paths/technology/", ["Hermes Technology emphasizes preview, human approval, privacy boundaries, auditability, and controlled integrations."]),
...
export const aiVisibilityWaveProviders: Array<{ id: Exclude<AiVisibilityProvider, "other">; label: string }> = [
