...
export const aiVisibilityPrompts: AiVisibilityPrompt[] = [
  ...
  createPrompt("ACA-11", "academy", "en", "Worldwide", "brand_discovery", "What programs are publicly offered by Hermes Academy?", "/paths/academy/", ["Hermes Academy presents two public programs: U.S. Logistics Operations and Marketing."]),
