...
export const aiVisibilityPrompts: AiVisibilityPrompt[] = [
  ...
  createPrompt("MKT-01", "marketing", "en", "United States", "commercial", "Which SEO agencies understand trucking and logistics companies?", "/services/seo/", ["Hermes Marketing includes SEO review for service businesses.", "ProgressoPro remains a separately governed operating label and is not asserted as the root provider identity."]),
