...
export const digitalServicePages: Record<string, DigitalServicePageContent> = {
  websiteDevelopment: {
    ...
    description: "Custom website development for U.S. businesses: discovery, architecture, responsive design, engineering, conversion paths, analytics planning, QA, and controlled release.",
    eyebrow: "Hermes IT Development · National Service",
    h1: "Custom Website Development for U.S. Businesses",
    intro: "Hermes plans and builds business websites around the company, its customers, and the action each visitor should take. The engagement starts with discovery and information architecture, then moves through responsive design, engineering, quality assurance, and a controlled release.",
    audience: [
      ...
      "Teams planning multilingual, CRM, booking, payment, or automation phases",
    ],
    deliverables: [
      { title: "Business discovery", body: "Clarify the company, services, audiences, public claims, required pages, customer actions, content responsibilities, and release constraints." },
      ...
      { title: "Engineering and technical SEO", body: "Build clean, crawlable pages with metadata, canonical URLs, structured data where supported, sitemap coverage, performance controls, and maintainable code." },
      { title: "Contact and qualification workflow", body: "Design an honest inquiry path with direct contact fallback. Live delivery, CRM writes, booking, payments, and integrations are connected only when separately reviewed and approved." },
      { title: "Quality and controlled release", body: "Check build output, links, forms, keyboard behavior, mobile layouts, accessibility, privacy boundaries, analytics events, and browser workflows before release review." },
    ],
    process: [
      { title: "Discovery", body: "Define the business goal, audience, services, evidence, content, languages, constraints, integrations, and desired customer action." },
      { title: "Architecture and brief", body: "Approve page structure, navigation, content responsibilities, conversion path, technical requirements, and phased scope." },
      { title: "Design and build", body: "Create the interface, components, pages, metadata, structured data, contact workflow, and approved integrations." },
      { title: "QA and review", body: "Run automated and browser checks, repair defects, review claims and privacy, and prepare the release record." },
      { title: "Launch and improvement", body: "Release only after approval, then use Search Console, analytics, inquiries, and user feedback to prioritize controlled improvements." },
    ],
    boundaries: [
      "Branding, copywriting, content migration, ecommerce, booking, payments, CRM, AI, hosting, and third-party integrations are included only when the agreed scope says so.",
      "A website project does not guarantee rankings, traffic, leads, revenue, ROI, or a fixed completion date before discovery.",
      "No live submission, payment, booking, message, account, or external-system connection is activated without technical review and approval.",
      "The public site must not expose private company records, credentials, internal prompts, customer data, or unsupported claims.",
    ],
    faq: [
      ...
      { question: "Can Hermes redesign an existing website instead?", answer: "Yes. Existing websites can be reviewed for structure, usability, mobile quality, conversion paths, technical SEO, migration risk, content, analytics, and integration needs before a redesign scope is proposed." },
      { question: "Can the website connect to a CRM, booking system, or payments?", answer: "Potentially, when the required platform, permissions, data flow, privacy, security, fallback, and operating responsibilities are reviewed. A connection is not assumed or activated automatically." },
      { question: "Does website development guarantee search rankings or leads?", answer: "No. Hermes can improve the website, technical foundation, content architecture, conversion paths, and measurement. Search engines and market behavior remain outside Hermes control." },
      { question: "How does the project begin?", answer: "Share the company, services, audience, current website if one exists, target U.S. market, customer languages, desired customer action, references, constraints, and the next business result the website should support." },
    ],
    related: [
