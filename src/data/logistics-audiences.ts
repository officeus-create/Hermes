...
export const logisticsAudiences: LogisticsAudience[] = [
  ...
  },
  {
    ...
    label: "Work with us",
    eyebrow: "Careers",
    title: "Review verified Hermes career openings and training paths.",
    summary: "Public recruiting is fail-closed: Hermes lists a role only after the vacancy, application route, review date, and owner approval are verified. When no vacancy is verified open, no general job application is collected from this page.",
    needs: ["Verified vacancy status", "Role-specific requirements", "Approved application route", "Current review date and owner approval"],
    steps: [
      { title: "Check current vacancy status", body: "Confirm whether Hermes currently lists a verified, owner-approved public opening before preparing candidate information." },
      { title: "Use only the approved route", body: "A role-specific application route appears only with a verified open vacancy; unrelated contact, Academy, customer, or commercial forms are not job applications." },
      { title: "Explore training separately", body: "Academy learning and practice remain separate from hiring and do not guarantee an interview, placement, employment, or future paid work." },
    ],
    faq: [
      { question: "Can I submit a general job application when no vacancy is verified open?", answer: "Not from this page. Hermes keeps public recruiting fail-closed until a specific vacancy and its approved application route are verified." },
      { question: "Where should I check for an opening?", answer: "Use the current vacancy status on this page. A role appears publicly only after its scope, application route, review date, status, and owner approval are verified." },
      { question: "Is training available if no job is open?", answer: "Academy learning paths may be available separately, but training or practice does not guarantee an interview, employment, income, placement, or future paid work." },
    ],
    primary: { label: "View current vacancy status", href: "#career-status-title" },
    secondary: { label: "Explore training separately", href: "/paths/academy/" },
  },
];
