...
export const websiteProofRegister: ProofRecord[] = [
  ...
  },
  {
    ...
    label: "CRM & Operations Control",
    maturity: "working_prototype",
    evidencePath: "/paths/technology/",
    requiredVisibleEvidence: ["Working prototype", "CRM & Operations Control", "Demo data"],
    publicClaimBoundary: "The interface is a working prototype and must not be described as a connected production CRM.",
  },
  {
    id: "hermes-connect",
    label: "Hermes Connect",
    maturity: "product_discovery",
    evidencePath: "/paths/technology/",
    requiredVisibleEvidence: ["Product discovery", "Hermes Connect", "Concept only"],
    publicClaimBoundary: "No account, booking, calendar, payment, or AI action is represented as connected.",
  },
  {
