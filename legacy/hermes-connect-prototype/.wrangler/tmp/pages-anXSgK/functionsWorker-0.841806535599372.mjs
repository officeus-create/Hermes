...
__export(auth_exports, {
  ...
  verifyTelegramAuth: () => verifyTelegramAuth
});
...
var PBKDF2_ITERATIONS, SALT_BYTES, HASH_BYTES, SESSION_BYTES, SESSION_TTL_MS, TELEGRAM_AUTH_MAX_AGE_SECONDS;
var init_auth = __esm({
  "../src/auth.mjs"() {
...
var init_register = __esm({
  "api/auth/register.ts"() {
    ...
    cleanText = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS, "").trim().slice(0, max), "cleanText");
...
var CONTACT_METHODS, CONTACT_METHOD_IDS;
...
var CONTROL_CHARS2, cleanText2, isValidEmail2;
var init_booking = __esm({
  "api/public/booking/index.ts"() {
    ...
    cleanText2 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS2, "").trim().slice(0, max), "cleanText");
    isValidEmail2 = /* @__PURE__ */ __name((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), "isValidEmail");
...
var CONTROL_CHARS3, cleanText3, isValidEmail3;
var init_meeting = __esm({
  "api/public/meeting/index.ts"() {
    ...
    cleanText3 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS3, "").trim().slice(0, max), "cleanText");
    isValidEmail3 = /* @__PURE__ */ __name((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), "isValidEmail");
...
var init_id2 = __esm({
  "api/booking/[id].ts"() {
    ...
    cleanText4 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS4, "").trim().slice(0, max), "cleanText");
...
var init_email = __esm({
  "api/clients/[email].ts"() {
    ...
    cleanText5 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS5, "").trim().slice(0, max), "cleanText");
...
var MAX_SERVICES, MAX_AVAILABILITY_SLOTS, CONTROL_CHARS6, cleanText6, unique;
var init_id3 = __esm({
  "api/staff/[id].ts"() {
    init_functionsRoutes_0_38791969161777384();
    init_session();
    ...
    cleanText6 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS6, "").trim().slice(0, max), "cleanText");
    unique = /* @__PURE__ */ __name((values) => [...new Set(values)], "unique");
...
var MAX_SERVICES2, MAX_AVAILABILITY_SLOTS2, CONTROL_CHARS7, cleanText7, unique2;
var init_profile = __esm({
  "api/profile.ts"() {
    ...
    cleanText7 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS7, "").trim().slice(0, max), "cleanText");
    unique2 = /* @__PURE__ */ __name((values) => [...new Set(values)], "unique");
...
var MAX_STAFF, MAX_SERVICES3, MAX_AVAILABILITY_SLOTS3, CONTROL_CHARS8, cleanText8, unique3;
var init_staff = __esm({
  "api/staff.ts"() {
    ...
    cleanText8 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS8, "").trim().slice(0, max), "cleanText");
    unique3 = /* @__PURE__ */ __name((values) => [...new Set(values)], "unique");
...
// ../.wrangler/tmp/bundle-pSQo0L/middleware-loader.entry.ts
init_functionsRoutes_0_38791969161777384();

// ../.wrangler/tmp/bundle-pSQo0L/middleware-insertion-facade.js
init_functionsRoutes_0_38791969161777384();
...
//# sourceMappingURL=functionsWorker-0.841806535599372.mjs.map
