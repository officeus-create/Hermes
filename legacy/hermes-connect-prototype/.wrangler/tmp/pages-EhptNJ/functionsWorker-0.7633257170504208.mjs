...
var cleanText = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS, "").trim().slice(0, max), "cleanText");
...
var cleanText2 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS2, "").trim().slice(0, max), "cleanText");
var isValidEmail2 = /* @__PURE__ */ __name((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), "isValidEmail");
...
var cleanText3 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS3, "").trim().slice(0, max), "cleanText");
var isValidEmail3 = /* @__PURE__ */ __name((value) => /^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(value), "isValidEmail");
...
var cleanText4 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS4, "").trim().slice(0, max), "cleanText");
...
var cleanText5 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS5, "").trim().slice(0, max), "cleanText");
...
var cleanText6 = /* @__PURE__ */ __name((value, max) => String(value ?? "").replace(CONTROL_CHARS6, "").trim().slice(0, max), "cleanText");
var unique = /* @__PURE__ */ __name((values) => [...new Set(values)], "unique");
...
// ../.wrangler/tmp/pages-EhptNJ/functionsRoutes-0.9496867648119589.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-YQL75U/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-YQL75U/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7633257170504208.mjs.map
