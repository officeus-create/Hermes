export async function ensureRepairShopBookingsSchema(db) {
  ...
  // The original exact-slot unique index also blocked a legitimate rebooking after cancellation.
  // Replace it with an active-booking-only constraint. Existing booking rows are untouched.
