...
const FIRST_LOAD_PATHS = new Set([
...
export async function onRequest(context: Context) {
  ...
  if (request.method !== "GET" || !FIRST_LOAD_PATHS.has(new URL(request.url).pathname) || !env.DB) {
    return context.next();
  }
