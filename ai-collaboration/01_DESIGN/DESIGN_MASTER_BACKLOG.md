...
- IN PROGRESS — implementation exists on the active design branch but is not merged/live.
...
- [ ] Verify global Hermes Connect launcher treatment across all path pages.

### P2 — responsive and accessibility pass
- [ ] Build a page/component inventory for visual QA.
- [ ] Validate 390 / 430 / 768 / 1024 / 1440 widths for highest-value public and Connect routes.
- [ ] Eliminate horizontal overflow and clipped tap targets.
- [ ] Audit keyboard focus visibility, contrast and reduced-motion behavior on touched components.
- [ ] Audit long EN/RU labels for wrapping and layout stability.

### P3 — division color application
- [ ] Reconcile historical four-color board with current semantic tokens and document exact canonical mapping.
- [ ] Apply division color as restrained context signal to approved components without global page recoloring.
...
- [ ] Audit shared account/workspace navigation across Repair Shop, Academy and AI surfaces.
- [ ] Reduce duplicate navigation concepts between public shell and signed-in workspace.
- [ ] Normalize empty/loading/error states.
- [ ] Normalize drawers/modals/forms/table density for mobile.
- [ ] Verify Russian UI continuity through private navigation.

### P5 — product UX
- [ ] Design the production Website Factory intake flow from the existing product concept: sign-in, source links, business extraction, voice/text brief, competitor references by role, review, build handoff.
- [ ] Define reusable upload/link/competitor/brief components instead of a one-off wizard.
- [ ] Integrate validation, progress, save/resume and clear next-step states.

### P6 — brand system consolidation
- [ ] Consolidate the production brand truth into Hermes Brand System 2.0.
- [ ] Include mark rules, minimum size, clear space, inverse/mono, division accents, typography, spacing, buttons, cards, imagery, motion, public/private examples and do/don'ts.
- [ ] Consolidate design evidence and decision records into a navigable archive.
- [ ] Retire contradictory historical logo guidance while retaining it as labelled history.
