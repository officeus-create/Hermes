...
- The free root-domain Backlink Audit completed on 2026-09-25. It reports a **High** overall toxicity score across 241 referring domains and 265 active backlinks. The “Backlinks to Review” queue contains 201 toxic, six potentially toxic and 58 non-toxic links. In the most recent spike, 65 of 67 new domains were labelled toxic; prominent markers are link-network URL paths (169), repeated page titles (118), frequent anchors (63) and de-indexed domains (54). The tool also found one malformed 404 target (`/%20rel=nofollow`) affected by four backlinks. These labels identify a manual review queue; no link was marked for removal, outreach, export, whitelist or Google disavow.
- The original On Page SEO Checker snapshot contained 57 ideas for eight pages from 2026-09-15: 35 content, eight semantic, eight backlink, three SERP-feature, two UX and one technical idea. The campaign was cleaned to four canonical owners: homepage, Load Board, car-hauling dispatch and logistics SEO. Removed targets were the duplicate UI-state URL `/load-board/?role=broker`, generic SEO mapped to niche `logistics seo`, and two local pages mapped to competitor/ambiguous brand terms (`badger vehicle shipping`, `countryside auto transport`). No live site page was removed.
- The remaining snapshot includes stale keyword-placement advice already satisfied in current code. Its free rerun is blocked because all 10 monthly keywords were used before the cleanup.
