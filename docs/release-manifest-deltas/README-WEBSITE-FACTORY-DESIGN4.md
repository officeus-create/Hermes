# Website Factory Design 4 replay

This branch preserves the owner-scoped Website Factory B1 backend and nine-step brief workflow from historical PR #955 while replacing its stale standalone account/visual shell with the current Hermes Connect Design OS.
...
- old #955 is not closed until this replacement passes exact-head CI on current main and demonstrably preserves the backend workflow.
