...
| ERR-SEO-003 | ACTIVE | Bing crawl and snippet hygiene | Authenticated Bing review on 2026-08-21 found 22 indexed of 27 known URLs, two commercial pages discovered but not crawled, a 166-character dispatch description, a duplicated Cloudflare-managed block in production `robots.txt`, and one noindex attorney-review draft producing the only Site Scan error and warning. | Review and merge the bounded `fix/bing-webmaster-cleanup-2026-08-21` patch after green CI; then verify production headers, metadata and one non-duplicated edge-managed robots block before requesting recrawl of the two commercial URLs. | Do not mass-submit all sitemap URLs, buy links, weaken noindex on contracts, disable AI crawler policy, or change Cloudflare account settings merely to improve a tool score. |
...
| ERR-EXT-002 | RESOLVED | Bing Webmaster Tools access | Earlier connected environments could not verify the existing Hermes Bing property. | On 2026-08-21 the authenticated existing property was independently opened without creating another account; Search Performance, AI Performance, URL Inspection, Site Explorer, Sitemaps, IndexNow, URL Submission, Backlinks, Keyword Research, Recommendations, Site Scan, Configuration, Tools, Security, users and Clarity status were reviewed read-only. |
