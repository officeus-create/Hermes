...
- A root-domain Backlink Audit campaign was started and left to calculate. No outreach, removal, export, disavow, trial, purchase, merge or deployment was performed. Site Audit and On Page reruns, Position Tracking, JS Impact and detailed AI reports are blocked by the current free-plan quotas or trial boundary.
