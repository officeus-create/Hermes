...
- Files changed: `src/pages/services/hermes-connect/index.astro`, `src/components/HermesConnectCapabilityPage.astro`, `src/pages/logistics/resources/index.astro`, `scripts/hermes-connect-product.test.mjs`, `docs/ERROR_REGISTER.md`, `docs/SEO_GSC_SEMRUSH_OWNER_MAP_2026-09-25.md`, and this handoff.
